...
import type { EffectiveVariantResponse, Settings, SkhdVariantSetting } from '../types';
 ...
 * ```
 */
export async function setSkhdVariantSetting(value: SkhdVariantSetting): Promise<void> {
 ...
 * ```
 */
export function getVariantWarning(effective: EffectiveVariantResponse): string | null {
 ...
 * ```
 */
export function isVariantInstalled(effective: EffectiveVariantResponse): boolean {
